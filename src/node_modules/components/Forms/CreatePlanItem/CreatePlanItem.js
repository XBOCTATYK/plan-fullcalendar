...
import CreateFormSlider from "components/Forms/CreatePlanItem/Slider/CreateFormSlider";
...
class CreatePlanItem extends Component {
    ...
    submit = (data) => {
        ...
        if (this.props.params.editIndex) {
            this.props.planItemsCollection.editItem(params, this.props.params.editIndex);
        } else {
